...
export default function PokedexPage() {
  ...
  // Fetch the lightweight list of all Pokemon names
  const fetchAllPokemonNames = useCallback(async () => {
    ...
    try {
      ...
      setError('Failed to load Pokemon database. Please try again.');
      setLoading(false);
    }
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="font-mono text-charcoal text-sm md:text-base mt-4 max-w-xl">
            Complete index of {allPokemon.length.toLocaleString()} registered Pokemon species. 
        ...
        {loading && !error && (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="font-mono text-charcoal text-sm">Loading database...</p>
          </div>
        )}
