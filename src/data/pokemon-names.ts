/**
 * Complete Pokemon Name Database (Gen 1-9: IDs 1-1025)
 * 
 * This file contains all official Pokemon names for SSG (Static Site Generation).
 * These names are used to generate static pages at build time.
 * 
...
export const POKEMON_NAMES: Record<number, string> = {
  ...
  1011: "dipplin", 1012: "poltchageist", 1013: "sinistcha", 1014: "okidogi", 1015: "munkidori",
  1016: "fezandipiti", 1017: "ogerpon", 1018: "archaludon", 1019: "hydrapple", 1020: "gouging-fire",
  1021: "raging-bolt", 1022: "iron-boulder", 1023: "iron-crown", 1024: "terapagos", 1025: "pecharunt",
};

/**
 * Get Pokemon name by ID
 * Falls back to "pokemon-{id}" if not found (shouldn't happen with complete data)
 */
