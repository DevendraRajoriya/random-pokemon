            ...
            <div key={step}>
              <div className="bg-black text-white p-4 slasher">
                <div className="flex items-center gap-3">
                  <span className="text-marigold font-mono text-xs font-bold">STEP 0{step}</span>
        ...
        <div className="border-2 border-black bg-white p-6 md:p-8 slasher">
          ...
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map((challenge) => (
              <div key={challenge} className={`flex items-start gap-4 ${challenge < 5 ? 'border-b border-black/10 pb-4' : ''}`}>
                <span className="bg-marigold text-black font-mono text-xs font-bold px-2 py-1 slasher">0{challenge}</span>
                <div>
